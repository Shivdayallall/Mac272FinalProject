      ...
      <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
        ...
        <div class="u-nav-container">
          <ul class="u-nav u-unstyled u-nav-1">
            ...
            <li class="u-nav-item">
              <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="cart.php" style="padding: 10px 20px;"><img src="./IMG/cart.png" alt="">
            ...
            <li class="u-nav-item">
                <a class="u-button-style  badge rounded-pill bg-info text-dark" href="logout.php" style="padding: 10px 20px;">Log out</a>
            </li>
        ...
        ?>
            ...
            <div class="card mb-3" style="max-width: 540px;">
              ...
              <form method="POST" action="page-1.php?action=add&id=<?php echo $row['id']; ?>">
                ...
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src='./food-image/<?php echo $row['foodimage']; ?>' class="img-fluid rounded-start" alt="...">
                  </div>
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      ...
                      <input type="number" name="quantity" class="form-control" id="quantityInput" value="1" />
